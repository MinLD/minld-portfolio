...
import { createMomentCategoryController, deleteMomentCategoryController, getMomentCategoryController, listMomentCategoriesController, updateMomentCategoryController } from './moment-category.controller.js'
import { createMomentCategorySchema, momentCategoryIdSchema, updateMomentCategorySchema } from './moment-category.schema.js'

export const publicMomentCategoryRouter = Router()
export const adminMomentCategoryRouter = Router()

publicMomentCategoryRouter.get('/moment-categories', listMomentCategoriesController)
...
adminMomentCategoryRouter.get('/moment-categories', listMomentCategoriesController)
