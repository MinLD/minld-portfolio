...
<template>
  <div class="mt-20 relative flex flex-col items-center text-center pb-5 space-y-6 mb-5">
    ...
    <div class="space-y-4">
      <p class="text-xs font-bold tracking-[0.2em] text-muted-foreground uppercase">Gallery</p>
      <h1 class="text-4xl md:text-6xl font-bold tracking-tight font-serif">Locket Library</h1>
