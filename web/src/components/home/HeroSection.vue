...
<template>
  ...
  <section class="relative flex h-dvh w-full items-center justify-center overflow-hidden px-6">
    <div
        ...
        <div class="flex gap-6">
          ...
          ><a
            ...
            ><svg
              ...
              stroke-linejoin="round"
            >
              <path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path></svg></a
          ><a
            href="https://github.com/minld/"
            target="_blank"
            rel="noopener noreferrer"
            class="text-muted-foreground hover:text-foreground transition-colors p-1 hover:scale-120 hover:rotate-6 transition-transform duration-300"
            data-state="closed"
