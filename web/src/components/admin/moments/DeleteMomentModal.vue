    ...
    >
      <div class="w-full max-w-md rounded-xl border border-zinc-800 bg-[#18181b] shadow-2xl">
        <div class="flex items-start justify-between border-b border-zinc-800 px-6 py-4">
          <div>
            <h2 class="text-base font-semibold text-white">Delete Moment</h2>
        ...
        <div class="px-6 py-5">
          <p class="text-sm leading-6 text-zinc-300">
            ...
            <span class="font-medium text-white">"{{ moment?.content?.slice(0, 80) }}"</span>
            ?
          </p>

          <div class="mt-4 rounded-lg border border-red-900/60 bg-red-950/30 px-4 py-3">
            <p class="text-sm text-red-300">The moment and related data may be permanently removed.</p>
          </div>
        </div>
